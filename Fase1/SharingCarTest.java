...
public class SharingCarTest {
	...
	public void testSearchOrigin() {
		assertEquals("Check searchOrigin Madrid.", true, 
				SharingCar.searchOrigin("Madrid", new LstRequest()).equals( new LstRequest()));


		assertEquals("Check searchOrigin Madrid.", true, 
				SharingCar.searchOrigin("Madrid", lst2).equals(searchOMadrid));

		assertEquals("Check searchOrigin Madrid.", false, 
				SharingCar.searchOrigin("Madrid", lst2).equals(lst2));
	...
	public void testSearchDestination() {
		...
		assertEquals("Check searchDestination Barcelona.", true, 
				SharingCar.searchDestination("Barcelona", new LstRequest()).equals(new LstRequest()));


		assertEquals("Check searchDestination Barcelona.", true, 
				SharingCar.searchDestination("Barcelona", lst2).equals(searchDBarcelona));

		assertEquals("Check searchDestination Barcelona.", false, 
				SharingCar.searchDestination("Barcelona", lst2).equals(lst2));	}
